...
tags:
  ...
  - Astro
banner:
  heading: I read enough
  ctaText: Let's start
  ctaUrl: /contact
metadata:
  title: Markdown elements demo post
  description: Demo content for Markdown elements and embedded components in the SmartBuoy blog.
  openGraph:
    locale: en_US
    type: article
---
...
import CallToActionBanner from '~/components/blog/CallToActionBanner.astro';
...
<CallToActionBanner heading="I read enough" ctaText="Let's start" ctaUrl="/contact" />
